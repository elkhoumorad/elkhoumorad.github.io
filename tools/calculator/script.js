...
function updateCustomListUI() {
    ...
    for (let name in savedConstants) {
       ...
       li.innerHTML = `
            <div onclick="insert('${name}')" style="display: flex; flex: 1; justify-content: space-between; align-items: center; cursor: pointer; padding-right: 20px; min-width: 0;">
                
                <span style="display: flex; align-items: baseline; gap: 8px; min-width: 0; padding-right: 15px;">
